...
namespace bx
{
	...
	inline MpScUnboundedQueueT<Ty>::MpScUnboundedQueueT(t_allocator* _allocator)
		: m_queue(_allocator)
	{
	}
	...
	template <typename Ty>
	inline MpScUnboundedBlockingQueue<Ty>::MpScUnboundedBlockingQueue(t_allocator* _allocator)
		: m_queue(_allocator)
	{
	}
