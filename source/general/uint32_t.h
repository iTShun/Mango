...
static inline uint32_t uint32_li(uint32_t _a)
{
    return _a;
}

static inline uint32_t uint32_dec(uint32_t _a)
{
    return _a - 1;
}

static inline uint32_t uint32_inc(uint32_t _a)
{
    return _a + 1;
}

static inline uint32_t uint32_not(uint32_t _a)
{
    return ~_a;
}

static inline uint32_t uint32_neg(uint32_t _a)
{
    return -(int32_t)_a;
}

static inline uint32_t uint32_ext(uint32_t _a)
{
    return ( (int32_t)_a)>>31;
}

static inline uint32_t uint32_and(uint32_t _a, uint32_t _b)
{
    return _a & _b;
}

static inline uint32_t uint32_andc(uint32_t _a, uint32_t _b)
{
    return _a & ~_b;
}

static inline uint32_t uint32_xor(uint32_t _a, uint32_t _b)
{
    return _a ^ _b;
}

static inline uint32_t uint32_xorl(uint32_t _a, uint32_t _b)
{
    return !_a != !_b;
}

static inline uint32_t uint32_or(uint32_t _a, uint32_t _b)
{
    return _a | _b;
}

static inline uint32_t uint32_orc(uint32_t _a, uint32_t _b)
{
    return _a | ~_b;
}

static inline uint32_t uint32_sll(uint32_t _a, int _sa)
{
    return _a << _sa;
}

static inline uint32_t uint32_srl(uint32_t _a, int _sa)
{
    return _a >> _sa;
}

static inline uint32_t uint32_sra(uint32_t _a, int _sa)
{
    return ( (int32_t)_a) >> _sa;
}

static inline uint32_t uint32_rol(uint32_t _a, int _sa)
{
    return ( _a << _sa) | (_a >> (32-_sa) );
}

static inline uint32_t uint32_ror(uint32_t _a, int _sa)
{
    return ( _a >> _sa) | (_a << (32-_sa) );
}

static inline uint32_t uint32_add(uint32_t _a, uint32_t _b)
{
    return _a + _b;
}

static inline uint32_t uint32_sub(uint32_t _a, uint32_t _b)
{
    return _a - _b;
}

static inline uint32_t uint32_mul(uint32_t _a, uint32_t _b)
{
    return _a * _b;
}

static inline uint32_t uint32_div(uint32_t _a, uint32_t _b)
{
    return (_a / _b);
}

static inline uint32_t uint32_mod(uint32_t _a, uint32_t _b)
{
    return (_a % _b);
}

static inline uint32_t uint32_cmpeq(uint32_t _a, uint32_t _b)
{
    return -(_a == _b);
}

static inline uint32_t uint32_cmpneq(uint32_t _a, uint32_t _b)
{
    return -(_a != _b);
}

static inline uint32_t uint32_cmplt(uint32_t _a, uint32_t _b)
{
    return -(_a < _b);
}

static inline uint32_t uint32_cmple(uint32_t _a, uint32_t _b)
{
    return -(_a <= _b);
}

static inline uint32_t uint32_cmpgt(uint32_t _a, uint32_t _b)
{
    return -(_a > _b);
}

static inline uint32_t uint32_cmpge(uint32_t _a, uint32_t _b)
{
    return -(_a >= _b);
}

static inline uint32_t uint32_setnz(uint32_t _a)
{
    return -!!_a;
}

static inline uint32_t uint32_satadd(uint32_t _a, uint32_t _b)
{
...
static inline uint32_t uint32_satsub(uint32_t _a, uint32_t _b)
{
...
static inline uint32_t uint32_satmul(uint32_t _a, uint32_t _b)
{
...
static inline uint32_t uint32_sels(uint32_t test, uint32_t _a, uint32_t _b)
{
...
static inline uint32_t uint32_selb(uint32_t _mask, uint32_t _a, uint32_t _b)
{
...
static inline uint32_t uint32_imin(uint32_t _a, uint32_t _b)
{
...
static inline uint32_t uint32_imax(uint32_t _a, uint32_t _b)
{
...
static inline uint32_t uint32_min(uint32_t _a, uint32_t _b)
{
    return _a > _b ? _b : _a;
}

static inline uint32_t uint32_min_(uint32_t _a, uint32_t _b, uint32_t _c)
{
    return uint32_min(_a, uint32_min(_b, _c) );
}

static inline uint32_t uint32_max(uint32_t _a, uint32_t _b)
{
    return _a > _b ? _a : _b;
}

static inline uint32_t uint32_max_(uint32_t _a, uint32_t _b, uint32_t _c)
{
    return uint32_max(_a, uint32_max(_b, _c) );
}

static inline uint32_t uint32_clamp(uint32_t _a, uint32_t _min, uint32_t _max)
{
...
static inline uint32_t uint32_iclamp(uint32_t _a, uint32_t _min, uint32_t _max)
{
...
static inline uint32_t uint32_incwrap(uint32_t _val, uint32_t _min, uint32_t _max)
{
...
static inline uint32_t uint32_decwrap(uint32_t _val, uint32_t _min, uint32_t _max)
{
...
static inline uint32_t uint32_cntbits_ref(uint32_t _val)
{
...
static inline uint32_t uint32_cntlz_ref(uint32_t _val)
{
    const uint32_t tmp0   = uint32_srl(_val, 1);
...
static inline uint32_t uint32_cntlz(uint32_t _val)
{
#if BX_COMPILER_GCC || BX_COMPILER_CLANG
...
static inline uint32_t uint32_cnttz_ref(uint32_t _val)
{
...
static inline uint32_t uint32_cnttz(uint32_t _val)
{
#if BX_COMPILER_GCC || BX_COMPILER_CLANG
...
static inline uint32_t uint32_part1by1(uint32_t _a)
{
...
// to:
// ---- 9--8 --7- -6-- 5--4 --3- -2-- 1--0
static inline uint32_t uint32_part1by2(uint32_t _a)
{
...
static inline uint32_t uint32_testpow2(uint32_t _a)
{
...
static inline uint32_t uint32_nextpow2(uint32_t _a)
{
...
static inline uint16_t halfFromFloat(float _a)
{
...
static inline float halfToFloat(uint16_t _a)
{
    const uint32_t h_e_mask              = uint32_li(0x00007c00);
...
static inline uint16_t uint16_min(uint16_t _a, uint16_t _b)
{
    return _a > _b ? _b : _a;
}

static inline uint16_t uint16_max(uint16_t _a, uint16_t _b)
{
    return _a < _b ? _b : _a;
}

static inline int64_t int64_min(int64_t _a, int64_t _b)
{
    return _a < _b ? _a : _b;
}

static inline int64_t int64_max(int64_t _a, int64_t _b)
{
    return _a > _b ? _a : _b;
}

static inline int64_t int64_clamp(int64_t _a, int64_t _min, int64_t _max)
{
...
static inline uint32_t uint64_cntbits_ref(uint64_t _val)
{
...
/// Count number of bits set.
static inline uint32_t uint64_cntbits(uint64_t _val)
{
#if BX_COMPILER_GCC || BX_COMPILER_CLANG
...
static inline uint32_t uint64_cntlz_ref(uint64_t _val)
{
...
/// Count number of leading zeros.
static inline uint32_t uint64_cntlz(uint64_t _val)
{
#if BX_COMPILER_GCC || BX_COMPILER_CLANG
...
static inline uint32_t uint64_cnttz_ref(uint64_t _val)
{
...
static inline uint32_t uint64_cnttz(uint64_t _val)
{
#if BX_COMPILER_GCC || BX_COMPILER_CLANG
...
static inline uint64_t uint64_sll(uint64_t _a, int _sa)
{
    return _a << _sa;
}

static inline uint64_t uint64_srl(uint64_t _a, int _sa)
{
    return _a >> _sa;
}

static inline uint64_t uint64_sra(uint64_t _a, int _sa)
{
    return ( (int64_t)_a) >> _sa;
}

static inline uint64_t uint64_rol(uint64_t _a, int _sa)
{
    return ( _a << _sa) | (_a >> (32-_sa) );
}

static inline uint64_t uint64_ror(uint64_t _a, int _sa)
{
    return ( _a >> _sa) | (_a << (32-_sa) );
}

static inline uint64_t uint64_add(uint64_t _a, uint64_t _b)
{
    return _a + _b;
}

static inline uint64_t uint64_sub(uint64_t _a, uint64_t _b)
{
    return _a - _b;
}

static inline uint64_t uint64_mul(uint64_t _a, uint64_t _b)
{
    return _a * _b;
}

/// Greatest common divisor.
static inline uint32_t uint32_gcd(uint32_t _a, uint32_t _b)
{
    do
    {
        uint32_t tmp = _a % _b;
...
static inline uint32_t uint32_lcm(uint32_t _a, uint32_t _b)
{
    return _a * (_b / uint32_gcd(_a, _b) );
}

/// Align to arbitrary stride.
static inline uint32_t strideAlign(uint32_t _offset, uint32_t _stride)
{
...
static inline uint32_t strideAlign16(uint32_t _offset, uint32_t _stride)
{
...
static inline uint32_t strideAlign256(uint32_t _offset, uint32_t _stride)
{
